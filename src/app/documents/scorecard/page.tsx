...
function ScorecardContent() {
  ...
  return (
    <div>
      ...
      {result && (
        <p className="no-print" style={{ fontSize: "0.8rem", color: "var(--color-text-muted)", marginBottom: "1rem" }}>
      ...
      {s && !generating && (
        <div className="print-doc" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <div className="print-only" style={{ paddingBottom: "0.75rem", borderBottom: "1px solid #ccc" }}>
            <p style={{ fontWeight: 700, fontSize: "1rem", margin: 0 }}>Four Bottom Lines Scorecard</p>
